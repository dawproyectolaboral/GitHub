...
CREATE TABLE `pruebacultural` (
  ...
  CONSTRAINT `fk_pruebaCultural_parada1` FOREIGN KEY (`parada_idparada`) REFERENCES `parada` (`idparada`)
...
CREATE TABLE `pruebadeportiva` (
  ...
  CONSTRAINT `fk_pruebaDeportiva_parada1` FOREIGN KEY (`parada_idparada`) REFERENCES `parada` (`idparada`)
...
-- Dump completed on 2018-05-14 13:33:27
