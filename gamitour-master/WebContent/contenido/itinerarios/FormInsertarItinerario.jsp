...
<body>
 ...
 <div style="height: 60px;">
    ...
    <div class="cabecera">
            <a class="titcabecera" style="color:White;">INSERTAR ITINERARIO</a>
       </div>
            ...
            <div class="col-lg-4 col-md-5" style="margin:auto">
                <div class="form-container" style="overflow-y: auto;margin-top:-120px;">
                    <div class="media-container-column" data-form-type="formoid">
                        ...
                        <form action="../../InsertarItinerario.do" class="mbr-form" method="POST">
                            ...
                            <div style="max-height: 340px;">
                                ...
                                <div data-for="">
                                    <div class="form-group">
                                        <input type="text" class="form-control px-3" name="nombreItinerario" data-form-field="" placeholder="Nombre de Itinerario" id="name-header15-i">
                                    </div>
                                </div>
                                <div data-for="">
                                    <div class="form-group">
                                        <input type="text" class="form-control px-3" name="categoria" data-form-field="" placeholder="Categoría" id="email-header15-i">
                                    </div>
                                </div>
                                <div data-for="" >
                                        <div class="form-group" >
                                                ...
                                                <select name="duracion"  >
                                                            <option value="">&nbsp Duración</option>
                                                             <option value="0.5hora">0.5 horas</option>
                                                             <option value="1horas">1.0 horas</option>
                                                             <option value="1.5horas">1.5 horas</option>
                                                             <option value="2horas">2.0 horas</option>
                                                             <option value="2.5horas">2.5 horas</option>
                                                             <option value="3horas">3.0 horas</option>
                                                             <option value="+3horas">+3.0 horas</option>
