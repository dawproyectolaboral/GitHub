...
<div class="cabecera">
        <a class="titcabecera">INSERTAR ACTIVIDAD</a>
   </div>
...
<tr><td>Numero de participantes :</td><td> <input type="number" name="participantes" min="1"></td></tr>
<tr><td>Precio </td><td><input type="number" name="precio"></td></tr>
<tr><td>Puntos </td><td><input type="number" name="puntos" min="1"></td></tr>
