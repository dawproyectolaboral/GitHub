...
<body>
 ...
 <div style="height: 60px;">
    ...
    <div class="cabecera">
            <a class="titcabecera" style="color:White;">INSERTAR PREMIO</a>
       </div>
            ...
            <div class="col-lg-4 col-md-5" style="margin:auto">
                <div class="form-container" style="overflow-y: auto;margin-top:-120px;">
                    <div class="media-container-column" data-form-type="formoid">
                        <form action="InsertarPremio.do" class="mbr-form" method="POST">
...
<div data-for="">
                                    <div class="form-group">
                                          <div class="center-on-page">
                                                        ...
                                                        <div class="select">
   <select name="ganador">
	<c:forEach items="${listGanadores}" var="it">
		 <option value="${it.nick}">${it.nick}</option>
	</c:forEach>
</select>
                                ...
                                <div data-for="">
                                    <div class="form-group">
                                        <input type="text" class="form-control px-3" name="nombrepremio" data-form-field="" placeholder="Nombre de Premio" id="email-header15-i">
                                    </div>
                                </div>
                                <div data-for="">
                                    <div class="form-group">
                                        <textarea class="form-control px-3" name="descripcion" placeholder="Descripción" rows="6" cols="40" ></textarea>
                                    </div>
                                </div>
                                ...
                                <div data-for="">
                                    <div class="form-group">
                                        <input type="date" class="form-control px-3" name="fechadeactivacion" data-form-field="" placeholder="Fecha de Activación(año-mes-dia)" id="phone-header15-i">
                                    </div>
                                </div>

                                <div data-for="">
                                    <div class="form-group">
                                        <input type="date" class="form-control px-3" name="fechadeconsumo" data-form-field="" placeholder="Fecha de Consumo(año-mes-dia)" id="phone-header15-i">
                                    </div>
                                </div>

                                <div data-for="">
                                    <div class="form-group">
                                        <input type="number" class="form-control px-3" name="puntos" data-form-field="" placeholder="Puntos del Premio" id="phone-header15-i">
                                    </div>
                                </div>
