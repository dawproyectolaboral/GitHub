...
<title>Insertar p.cultural</title>
...
<body>
 ...
 <div style="height: 60px;">
    ...
    <div class="cabecera">
            <a class="titcabecera" style="color:White;">INSERTAR P.CULTURAL</a>
       </div>
...
<section class="cid-qQSwyVJLVG mbr-fullscreen mbr-parallax-background" id="header15-i">
            ...
            <div class="col-lg-4 col-md-5" style="margin:auto">
                <div class="form-container" style="overflow-y: auto;margin-top:-120px;">
                    <div class="media-container-column" data-form-type="formoid">
                        <form action="InsertarPCultural.do" class="mbr-form" method="POST">
                                ...
                                <div data-for="" >
                                        <div class="form-group" >
                                               ...
                                               <select name="numParada">
                                                <option value="">&nbsp Nombre Parada</option>
	<c:forEach items="${listparad}" var="para">
		 <option value="${para.numeroParada}">${para.nombre}</option>
                                ...
                                <div data-for="">
                                    <div class="form-group">
                                        <input type="text" class="form-control px-3" name="pregunta" data-form-field="" placeholder="Pregunta" id="phone-header15-i">
                                    </div>
                                </div>

                                <div data-for="">
                                    <div class="form-group">
                                        <input type="text" class="form-control px-3" name="respuesta" data-form-field="" placeholder="Respuesta" id="phone-header15-i">
                                    </div>
                                </div>
