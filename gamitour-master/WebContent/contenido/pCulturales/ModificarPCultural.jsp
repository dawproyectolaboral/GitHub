...
<div class="cabecera">
        <a class="titcabecera">MODIFICAR P.CULTURAL</a>
   </div>

<div class="contenido">
	<form action="ModificarPCultural.do" method="post">
	<table>
		...
		<tr>
			<td>Pregunta: </td>
			<td><input type="text" name="preguntaNueva" value="${pregunta}"/></td>
		</tr>
		<tr>
			<td>Respuesta: </td>
			<td><input type="text" name="respuestaNueva" value="${respuesta}"/></td>
		</tr>
		<tr>
			<td>Puntos: </td>
