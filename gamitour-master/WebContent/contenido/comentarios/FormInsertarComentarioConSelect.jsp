...
<body>
 ...
 <div style="height: 60px;">
    ...
    <div class="cabecera">
            <a class="titcabecera" style="color:White;">INSERTAR COMENTARIO</a>
       </div>
            ...
            <div class="col-lg-4 col-md-5" style="margin:auto">
                <div class="form-container" style="overflow-y: auto;margin-top:-120px;">
                    <div class="media-container-column" data-form-type="formoid">
                        <form action="InsertarComentarios.do" class="mbr-form" method="POST">
...
<div data-for="">
                                ...
                                <div data-for="">
                                    <div class="form-group">
                                         <div class="center-on-page">
                                                        ...
                                                        <div class="select">
          <select name="titulo">
           <option value="">&nbsp Título Multimedia</option>
	<c:forEach items="${listMulti}" var="mutl">
		 <option value="${mutl.titulo}">${mutl.titulo}</option>
                                ...
                                <div data-for="">
                                    <div class="form-group">
                                        <textarea class="form-control px-3" name="texto" placeholder="Texto" rows="6" cols="40" maxlength="200"></textarea>
                                    </div>
                                </div>
